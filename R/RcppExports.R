...
recordSwap_cpp <- function(data, similar, hierarchy, risk, hid, th, swaprate, carry_along, seed = 123456L) {
    .Call(`_recordSwapping_recordSwap_cpp`, data, similar, hierarchy, risk, hid, th, swaprate, carry_along, seed)
}
