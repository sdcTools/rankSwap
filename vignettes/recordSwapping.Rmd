...
+ using hierarchy level, `nuts1` to `nuts3` 
...
The data supplied to the function `recordSwap` should idealy be a data.table or data.frame. For more information on the function `recordSwap` the corresponding help page can be opened through
