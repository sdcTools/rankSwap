...
Sometimes it might however be useful to swap more variables then the ones stated in hierarchy.
...
Setting this parameter did however not interfere with swapping procedure
